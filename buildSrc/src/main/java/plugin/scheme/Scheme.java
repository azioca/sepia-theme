...
public class Scheme {
	...
	class Attributes {
		...
		List<Attribute> option = List.of(
			...
			new Attribute("DEFAULT_REASSIGNED_LOCAL_VARIABLE").foreground(palette.purple()).boldUnderscored(palette.purple()),
			new Attribute("DEFAULT_REASSIGNED_PARAMETER").foreground(palette.purple()).bold().boldUnderscored(palette.purple()),
