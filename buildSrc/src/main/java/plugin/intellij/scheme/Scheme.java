...
public class Scheme {
	...
	class Colors {
		...
		List<Option.Color> option = List.of(
			...
			new Option.Color("WHITESPACES_MODIFIED_LINES_COLOR", style.editor().background().selectedLine().darker()),
			...
			new Option.Color("VCS_ANNOTATIONS_COLOR_1", style.editor().background().base()),
			new Option.Color("VCS_ANNOTATIONS_COLOR_2", style.editor().background().base().darker()),
			new Option.Color("VCS_ANNOTATIONS_COLOR_3", style.editor().background().base().darker(2)),
			new Option.Color("VCS_ANNOTATIONS_COLOR_4", style.editor().background().base().darker(3)),
			new Option.Color("VCS_ANNOTATIONS_COLOR_5", style.editor().background().base().darker(4))
